...
var EditCustomerForm = function (_a) {
    var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
    var onSubmit = _a.onSubmit, initialData = _a.initialData;
    var _m = (0, react_hook_form_1.useForm)({
        defaultValues: initialData || {},
    }), register = _m.register, handleSubmit = _m.handleSubmit, reset = _m.reset, control = _m.control, errors = _m.formState.errors;
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4">
        ...
        {selectedCustomerType === customerInterfaces_1.CustomerType.PASE_DIARIO && (<>
            <div>
              ...
              <input type="date" className="w-full p-2 border border-gray-300 focus:outline-none focus:border-blue-500" {...register("dailyPass.accessDate", {
            required: "Este campo es requerido",
        })}/>
...
exports.default = EditCustomerForm;
